<template>
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        <h3 class="text-black font-semibold text-xl">Get in Touch with Mouse Makers</h3>
        <p class="mt-3 text-black w-fit">Have questions or ideas? We'd love to hear from you!</p>
      </div>
      <form @submit.prevent class="space-y-5 mt-5">
        ...
        <div>
          <label class="font-medium text-black">Company/Organization (Optional)</label>
...
export default {
  data() {
    return {
      ...
      data: null,
      servicesItems: [
        'Mouse Design Consultation',
        'Custom Mouse Creation',
        'Mouse Prototype Testing',
        'Bulk Mouse Orders',
      ],
      countryCode: 'US',
    };
